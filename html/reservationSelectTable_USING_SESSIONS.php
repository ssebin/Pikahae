...
//store table selection in the session variable
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    // Retrieve the TABLE SELECTED
    $tableSelection = $_POST['table_selection'];
     ...
     if (!empty($errors)) {
      ...
      $_SESSION['table_selection'] = $tableSelection;

    //Debugging output
    //echo "Table selected: " . $_SESSION['table_selection'] . "<br>";
 

    // Redirect to the table selection page
    header('Location: reservation-selection.php');
    exit();
...
<!-- Step 6: Generate HTML for the dropdown menu and seating map -->
