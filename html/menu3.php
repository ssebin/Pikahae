...
<section>
    <nav class="header">
        ...
        <div class="menu-head-cart" id="menu-head-cart">
            <h3 class="head-cart__heading">Cart<span class="cart-close">&times;</span></h3>
            ...
            <div class="head-cart__item">
                <div class="head-cart__item-wrapper">
                    ...
                    <img src="../images/menu/photo_food01_02.jpg" class="head-cart__item-img" alt="" />

                    <div class="head-cart__des">
                        <p class="head-cart__des-txt">Pikachu Burger</p>
                        <div class="head-cart__price">
                            <span class="head-cart__price-single">RM25.00*3</span>
                        </div>
                    </div>
                </div>
            </div>

            <h3 class="head-cart__price-total">RM75.00</h3>
...
<section class="menu" id="menu">
    ...
    <div id="food" class="d-food">
        ...
        $query = "SELECT menu_name, menu_price, menu_img, menu_cat FROM menu";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="box">
                ...
                <div class="item-text">
                    ...
                    <!-- The Modal -->
                    <span class="menu-details-btn">View details</span>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="item-section">
                                ...
                                <section class="item-detail">
                                    ...
                                    <p class="item-price">' . $menuPrice . '</p>
                                    <p class="item-desc">
